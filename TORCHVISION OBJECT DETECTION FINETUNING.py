...
Torchvision Object Detection Finetuning- Pytorch
Run in Spyder and pycharm
"""
...
image1 = Image.fromarray(img.mul(255).permute(1, 2, 0).byte().numpy())

#image1.show()

maskimg = Image.fromarray(prediction[0]['masks'][0, 0].mul(255).byte().cpu().numpy())
